...
<head>
    ...
    <title>Umugenzuzi | Rwanda Connect Document Post</title>
...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
			...
			<?php echo $error; ?>
			<form class="m-t-lg" role="form" method="POST" action="auth.php">
                <div class="form-group">
                    <input type="email" name="email" class="form-control" placeholder="Emeli yawe" >
                </div>
                <div class="form-group">
				...
				<button type="submit" name="submit" class="btn btn-success block full-width m-b">Login</button>
        ...
        <a href="index.php" class="btn-sm btn-white m-b">Back to Home Page</a>
    </div>
