<?php
	...
	if (isset($_POST['submit'])) {
		...
		$Misa_uzajyamo = $con->real_escape_string($_POST['Misa_uzajyamo']);
		$qry = $con->query("UPDATE twitabire_misa SET Misa_uzajyamo='$Misa_uzajyamo'")or die("NTIBIKUNZE KWIYANDIKISHA".mysqli_error());

                if ($qry)
                    $msg = "
					<div class='alert alert-success'>
					<button class='close' data-dismiss='alert'>&times;</button>
					<h2>Twiyandikisha bigenze neza! <strong>Urakoze!!!</strong></h2>
					</div>";
                else
                    $msg = "
					<div class='alert alert-danger'>
					<button class='close' data-dismiss='alert'>&times;</button>
					<h2><strong>Twiyandikisha ntikunze! Ongera ugerageze!</strong></h2>
					</div>";
	}
?>
<!DOCTYPE html>
...
$msg="";
$shaka=$_GET['doc_id'];
$sql = "SELECT * FROM documents WHERE doc_id='$shaka'";
                       ...
                       <form onSubmit="return check();" name="form" method="post" action="guhindura.php">
                            ...
                            <div class="col-sm-6 b-r">
								...
								<div class="form-group">
									<input name="id" class="form-control"  type="hidden" value="<?php echo $row ['doc_id']; ?>"/>
								</div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $row ['cost']; ?>" name="Umuryango_remezo" class="form-control b-r-md" disabled="disabled">
                                </div>
...
<?php 
	...
	//echo "IMPOSSIBLE"; 
	echo "<script>alert('Iyi nimero ya Telefoni siyo wakoreshe wiyandikisha! Urabeho!!!');window.location.href='index.php';</script>";
}?>
</section>
